package com.backend.userAndSecurityManagement.security.service;

import com.backend.userAndSecurityManagement.security.entity.AuditLog;
import com.backend.userAndSecurityManagement.security.repository.AuditLogRepository; // Ensure this import is present
